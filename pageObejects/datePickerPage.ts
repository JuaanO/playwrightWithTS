...
export class DatePickerPage extends HelperBase {
   ...
   async selectCommonDatePickerDateFromToday(numberOfDaysFromToday: number) {
      ...
      const dateToAssert = await this.selectDayInTheCalendar(
   ...
   async selectDatePickerWithRangeFromToday(
      ...
      const dateToAssertStart =
         await this.selectDayInTheCalendar(startDayFromToday);
      const dateToAssertEnd =
         await this.selectDayInTheCalendar(endDayFromToday);
